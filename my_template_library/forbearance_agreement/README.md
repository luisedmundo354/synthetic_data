...
# Accord Protocol Template: forbearance_agreement
...
```
cicero parse --template ./forbearance_agreement/ --dsl ./forbearance_agreement/sample.txt
...
data.json:
{
   "$class": "mycontract@1.0.0.MyRequest",
   "input": "World"
}
```

```
cicero execute --template ./forbearance_agreement/ --dsl ./forbearance_agreement/sample.txt --data ./forbearance_agreement/data.json 
```
...
```
{
   ...
   "request":{
      "$class":"mycontract@1.0.0.Request",
      "input":"World"
   },
   "response":{
      "$class":"mycontract@1.0.0.Response",
